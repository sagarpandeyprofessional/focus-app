...
declare function isMessageForThisClient(payload: any): boolean;
...
declare function attributeCursorToScreen(x: number, y: number, displayId?: string | null): ScreenId | null;
...
declare function updateViewerMainCanvas(screenId: ScreenId | null): void;
declare function showViewerPiP(previousScreenId: ScreenId): void;
...
declare function onScreenMetaUpdate(meta: any): void;
declare function createPresenterPeer(viewerId: string): Promise<void>;
declare function handleWebRTCOffer(payload: any, presenterId: string): Promise<void>;
